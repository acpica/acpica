...
Method(dv00)
{
	...
	if (LNotEqual(Local0, 0xabcd0003)) {
		err(ts, PK04(z167, __LINE__), 0x001, 0, 0, Local0, 0xabcd0003)
	}
}
...
Method(dv01, 1)
{
	...
	if (LNotEqual(Local0, 0x87654321)) {
		err(ts, PK04(z167, __LINE__), 0x003, 0, 0, Local0, 0x87654321)
	}

	if (LNotEqual(i000, 0x80000000)) {
		err(ts, PK04(z167, __LINE__), 0x004, 0, 0, i000, 0x80000000)
	}
}
...
Method(dv02)
{
	...
	if (LNotEqual(Local0, 0x00c00042)) {
		err(ts, PK04(z167, __LINE__), 0x006, 0, 0, Local0, 0x00c00042)
	}

	if (LNotEqual(i000, 0x0010000b)) {
		err(ts, PK04(z167, __LINE__), 0x007, 0, 0, i000, 0x0010000b)
	}
}
...
Method(dv03, 1)
{
	...
	if (LNotEqual(Local0, 0x87654321)) {
		err(ts, PK04(z167, __LINE__), 0x00c, 0, 0, Local0, 0x87654321)
	}

	if (LNotEqual(Local7, 1)) {
		err(ts, PK04(z167, __LINE__), 0x00d, 0, 0, Local7, 1)
	}
}
...
Method(dv04)
{
	...
	Method(m001, 2)
	{
		Method(m002, 2)
		{
			Method(m003, 2)
			{
				...
				if (LNotEqual(arg0, 0x00000300)) {
					err(ts, PK04(z167, __LINE__), 0x004, 0, 0, arg0, 0x00000300)
				}
				if (LNotEqual(arg1, 0x10000001)) {
					err(ts, PK04(z167, __LINE__), 0x004, 0, 0, arg1, 0x10000001)
				}
				Store(0x00004000, i000)
			...
			if (LNotEqual(arg0, 0x00000020)) {
				err(ts, PK04(z167, __LINE__), 0x004, 0, 0, arg0, 0x00000020)
			}
			if (LNotEqual(i000, 0x00000020)) {
				err(ts, PK04(z167, __LINE__), 0x004, 0, 0, i000, 0x00000020)
			}
			...
			if (LNotEqual(arg0, 0x10000002)) {
				err(ts, PK04(z167, __LINE__), 0x004, 0, 0, arg0, 0x10000002)
			}
			Store(0x00000300, i000)
			if (LNotEqual(i000, 0x00000300)) {
				err(ts, PK04(z167, __LINE__), 0x004, 0, 0, i000, 0x00000300)
			}
			if (LNotEqual(arg0, 0x10000002)) {
				err(ts, PK04(z167, __LINE__), 0x004, 0, 0, arg0, 0x10000002)
			}
		...
		if (LNotEqual(arg0, 0x00000001)) {
			err(ts, PK04(z167, __LINE__), 0x004, 0, 0, arg0, 0x00000001)
		}
		if (LNotEqual(i000, 0x00000001)) {
			err(ts, PK04(z167, __LINE__), 0x004, 0, 0, i000, 0x00000001)
		}
		...
		if (LNotEqual(arg0, 0x10000001)) {
			err(ts, PK04(z167, __LINE__), 0x004, 0, 0, arg0, 0x10000001)
		}
		Store(0x00000020, i000)
		if (LNotEqual(i000, 0x00000020)) {
			err(ts, PK04(z167, __LINE__), 0x004, 0, 0, i000, 0x00000020)
		...
		if (LNotEqual(arg1, 0x10000000)) {
			err(ts, PK04(z167, __LINE__), 0x004, 0, 0, arg1, 0x10000000)
		}
		Store(0x10000001, arg0)
		Store(0x00000020, i000)
...
Method(dv05)
{
	...
	Method(m001, 2)
	{
		...
		if (LNotEqual(Local0, arg1)) {
			err(ts, PK04(z167, __LINE__), 0x003, 0, 0, Local0, arg1)
		}
		Return (5)
	}
	...
	if (LNotEqual(Local0, 0xabcd0006)) {
		err(ts, PK04(z167, __LINE__), 0x003, 0, 0, Local0, 0xabcd0006)
	}
...
Method(dv06)
{
	...
	if (LNotEqual(Local0, c009)) {
		err(ts, PK04(z167, __LINE__), 0x003, 0, 0, Local0, c009)
	}
}
