...
Method(in20, 1)
{
	...
	if (LNotEqual(Local0, 0xabcd0003)) {
		err(ts, PK04(z165, __LINE__), 0x001, 0, 0, Local0, 0xabcd0003)
	}
}
...
Method(in21, 1)
{
	...
	if (LNotEqual(Local0, 0x87654321)) {
		err(ts, PK04(z165, __LINE__), 0x003, 0, 0, Local0, 0x87654321)
	}

	if (LNotEqual(i000, 0x00000001)) {
		err(ts, PK04(z165, __LINE__), 0x004, 0, 0, i000, 0x00000001)
	}
}
...
Method(in22)
{
	...
	if (LNotEqual(Local0, 0x00b0002d)) {
		err(ts, PK04(z165, __LINE__), 0x006, 0, 0, Local0, 0x00b0002d)
	}

	if (LNotEqual(i000, 0x00100000)) {
		err(ts, PK04(z165, __LINE__), 0x007, 0, 0, i000, 0x00100000)
	}
}
...
Method(in23, 2)
{
	...
	if (LNotEqual(Local0, 0x87654321)) {
		err(ts, PK04(z165, __LINE__), 0x00f, 0, 0, Local0, 0x87654321)
	}

	if (LNotEqual(arg1, 1)) {
		err(ts, PK04(z165, __LINE__), 0x010, 0, 0, arg1, 1)
	}
