...
Method(in30)
{
	...
	Method(m000, 2)
	{
		Method(m001, 2)
		{
			...
			if (LNotEqual(Local0, 0xabcd0000)) {
				err(ts, PK04(z166, __LINE__), 0x000, 0, 0, Local0, 0xabcd0000)
			}
			...
			if (LNotEqual(Local0, 0x11112222)) {
				err(ts, PK04(z166, __LINE__), 0x000, 0, 0, Local0, 0x11112222)
			}
		}
		m001(arg0, arg1)
	}
	...
	if (LNotEqual(Local0, 0xabcd0001)) {
		err(ts, PK04(z166, __LINE__), 0x000, 0, 0, Local0, 0xabcd0001)
	}
}
	...
	Method(m000, 2)
	{
		Method(m001, 2)
		{
			...
			if (LNotEqual(Local0, 0x33334444)) {
				err(ts, PK04(z166, __LINE__), 0x000, 0, 0, Local0, 0x33334444)
			}
		}
		m001(arg0, arg1)
	}
...
Method(in33)
{
	...
	if (LNotEqual(Local0, 0xabcd0002)) {
		err(ts, PK04(z166, __LINE__), 0x000, 0, 0, Local0, 0xabcd0002)
	}
}
...
Method(in34)
{
	...
	Method(m000, 2)
	{
		Method(m001, 2)
		{
			Store(DerefOf(Index(arg0, 0)), Local0)
			if (LNotEqual(Local0, 0xabcd0000)) {
				err(ts, PK04(z162, __LINE__), 0x000, 0, 0, Local0, 0xabcd0000)
			}
			Store(DerefOf(Index(arg0, 1)), Local0)
			if (LNotEqual(Local0, 0xabcd0001)) {
				err(ts, PK04(z162, __LINE__), 0x000, 0, 0, Local0, 0xabcd0001)
			}
			Store(DerefOf(Index(arg0, 2)), Local0)
			if (LNotEqual(Local0, 0xabcd0002)) {
				err(ts, PK04(z162, __LINE__), 0x000, 0, 0, Local0, 0xabcd0002)
			}
			Store(DerefOf(Index(arg0, 3)), Local0)
			if (LNotEqual(Local0, "i000")) {
				err(ts, PK04(z162, __LINE__), 0x000, 0, 0, Local0, "i000")
			}
			...
			Store(DerefOf(Index(arg0, 0)), Local0)
			if (LNotEqual(Local0, 0x11112222)) {
				err(ts, PK04(z162, __LINE__), 0x000, 0, 0, Local0, 0x11112222)
			}
		}
		m001(arg0, arg1)
	}
...
Method(in36)
{
	...
	Method(m000, 2)
	{
		Method(m001, 2)
		{
			...
			if (LNotEqual(Local0, 0x10)) {
				err(ts, PK04(z166, __LINE__), 0x000, 0, 0, Local0, 0x10)
			}
			...
			if (LNotEqual(Local0, 0x67)) {
				err(ts, PK04(z166, __LINE__), 0x000, 0, 0, Local0, 0x67)
			}
			...
			if (LNotEqual(Local0, 0x55)) {
				err(ts, PK04(z166, __LINE__), 0x000, 0, 0, Local0, 0x55)
			}
		}
		m001(arg0, arg1)
	}
	...
	if (LNotEqual(Local0, 0x67)) {
		err(ts, PK04(z166, __LINE__), 0x002, 0, 0, Local0, 0x67)
	}

	Store(DerefOf(Index(b000, 1)), Local0)
	if (LNotEqual(Local0, 0x11)) {
		err(ts, PK04(z166, __LINE__), 0x002, 0, 0, Local0, 0x11)
	}

	Store(DerefOf(Index(b000, 2)), Local0)
	if (LNotEqual(Local0, 0x12)) {
		err(ts, PK04(z166, __LINE__), 0x002, 0, 0, Local0, 0x12)
	}
}
...
Method(in37)
{
	...
	if (LNotEqual(Local0, 0x00a0002d)) {
		err(ts, PK04(z166, __LINE__), 0x00a, 0, 0, Local0, 0x00a0002d)
	}

	Store(DerefOf(Index(pp00, 1)), Local0)

	if (LNotEqual(Local0, 0x00100009)) {
		err(ts, PK04(z166, __LINE__), 0x00b, 0, 0, Local0, 0x00100009)
	}
...
Method(in38, 1)
{
	...
	if (LNotEqual(Local0, 0x07654321)) {
		err(ts, PK04(z166, __LINE__), 0x012, 0, 0, Local0, 0x07654321)
	}
	...
	if (LNotEqual(f001, Local1)) {
		err(ts, PK04(z166, __LINE__), 0x013, 0, 0, f001, Local1)
	}
...
Method(in39, 1)
{
	...
	if (LNotEqual(Local0, 0x07654321)) {
		err(ts, PK04(z166, __LINE__), 0x016, 0, 0, Local0, 0x07654321)
	}
	...
	if (LNotEqual(bnk0, Local1)) {
		err(ts, PK04(z166, __LINE__), 0x017, 0, 0, bnk0, Local1)
	}
...
Method(in3a, 1)
{
	...
	if (LNotEqual(Local0, 0x07070707)) {
		err(ts, PK04(z166, __LINE__), 0x01a, 0, 0, Local0, 0x07070707)
	}
	...
	if (LNotEqual(if00, Local1)) {
		err(ts, PK04(z166, __LINE__), 0x01b, 0, 0, if00, Local1)
	}
...
Method(in3c, 1)
{
	...
	if (LNotEqual(Local0, 0x1c)) {
		err(ts, PK04(z162, __LINE__), 0x01e, 0, 0, Local0, 0x1c)
	}
	...
	if (LNotEqual(Local0, Local1)) {
		err(ts, PK04(z162, __LINE__), 0x01f, 0, 0, Local0, Local1)
	}
...
Method(in3e)
{
	...
	if (LNotEqual(Local0, 0x07654321)) {
		err(ts, PK04(z162, __LINE__), 0x007, 0, 0, Local0, 0x07654321)
	}

	Store(DerefOf(Index(pp00, 1)), Local0)

	if (LNotEqual(Local0, 0x07000000)) {
		err(ts, PK04(z162, __LINE__), 0x008, 0, 0, Local0, 0x07000000)
	}
