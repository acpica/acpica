...
Method(in10)
{
	...
	Method(m001, 2)
	{
		...
		if (LNotEqual(Local0, 0xabcd0000)) {
			err(ts, PK04(z164, __LINE__), 0x000, 0, 0, Local0, 0xabcd0000)
		}
		...
		if (LNotEqual(Local0, 0x11112222)) {
			err(ts, PK04(z164, __LINE__), 0x000, 0, 0, Local0, 0x11112222)
		}
	}
	...
	if (LNotEqual(Local0, 0xabcd0001)) {
		err(ts, PK04(z164, __LINE__), 0x000, 0, 0, Local0, 0xabcd0001)
	}
}
...
Method(in11)
{
	...
	Method(m001, 2)
	{
		...
		if (LNotEqual(Local0, 0x33334444)) {
			err(ts, PK04(z164, __LINE__), 0x000, 0, 0, Local0, 0x33334444)
		}
	}
...
Method(in13)
{
	...
	if (LNotEqual(Local0, 0xabcd0002)) {
		err(ts, PK04(z164, __LINE__), 0x000, 0, 0, Local0, 0xabcd0002)
	}
}
...
Method(in14)
{
	...
	Method(m001, 2)
	{
		...
		if (LNotEqual(Local0, "i000")) {
			err(ts, PK04(z164, __LINE__), 0x000, 0, 0, Local0, "i000")
		}
...
Method(in16)
{
	...
	Method(m001, 2)
	{
		...
		if (LNotEqual(Local0, 0x10)) {
			err(ts, PK04(z164, __LINE__), 0x000, 0, 0, Local0, 0x10)
		}
		...
		if (LNotEqual(Local0, 0x67)) {
			err(ts, PK04(z164, __LINE__), 0x000, 0, 0, Local0, 0x67)
		}
		...
		if (LNotEqual(Local0, 0x55)) {
			err(ts, PK04(z164, __LINE__), 0x000, 0, 0, Local0, 0x55)
		}
	}
	...
	if (LNotEqual(Local0, 0x67)) {
		err(ts, PK04(z164, __LINE__), 0x002, 0, 0, Local0, 0x67)
	}

	Store(DerefOf(Index(b000, 1)), Local0)
	if (LNotEqual(Local0, 0x11)) {
		err(ts, PK04(z164, __LINE__), 0x002, 0, 0, Local0, 0x11)
	}

	Store(DerefOf(Index(b000, 2)), Local0)
	if (LNotEqual(Local0, 0x12)) {
		err(ts, PK04(z164, __LINE__), 0x002, 0, 0, Local0, 0x12)
	}
}
...
Method(in17)
{
	...
	if (LNotEqual(Local0, 0x00c00042)) {
		err(ts, PK04(z164, __LINE__), 0x00a, 0, 0, Local0, 0x00c00042)
	}

	Store(DerefOf(Index(pp00, 1)), Local0)

	if (LNotEqual(Local0, 0x0010000b)) {
		err(ts, PK04(z164, __LINE__), 0x00b, 0, 0, Local0, 0x0010000b)
	}
...
Method(in18, 1)
{
	...
	if (LNotEqual(Local0, 0x87654321)) {
		err(ts, PK04(z164, __LINE__), 0x012, 0, 0, Local0, 0x87654321)
	}
	...
	if (LNotEqual(f001, Local1)) {
		err(ts, PK04(z164, __LINE__), 0x013, 0, 0, f001, Local1)
	}
...
Method(in19, 1)
{
	...
	if (LNotEqual(Local0, 0x87654321)) {
		err(ts, PK04(z164, __LINE__), 0x016, 0, 0, Local0, 0x87654321)
	}
	...
	if (LNotEqual(bnk0, Local1)) {
		err(ts, PK04(z164, __LINE__), 0x017, 0, 0, bnk0, Local1)
	}
...
Method(in1a, 1)
{
	...
	if (LNotEqual(Local0, 0x87878787)) {
		err(ts, PK04(z164, __LINE__), 0x01a, 0, 0, Local0, 0x87878787)
	}
	...
	if (LNotEqual(if00, Local1)) {
		err(ts, PK04(z164, __LINE__), 0x01b, 0, 0, if00, Local1)
	}
...
Method(in1b, 1)
{
	...
	if (LNotEqual(Local0, 0x1c)) {
		err(ts, PK04(z164, __LINE__), 0x01e, 0, 0, Local0, 0x1c)
	}
	...
	if (LNotEqual(Local0, Local1)) {
		err(ts, PK04(z164, __LINE__), 0x01f, 0, 0, Local0, Local1)
	}
...
Method(in1d)
{
	...
	if (LNotEqual(Local0, 0x07654321)) {
		err(ts, PK04(z164, __LINE__), 0x007, 0, 0, Local0, 0x07654321)
	}

	Store(DerefOf(Index(pp00, 1)), Local0)

	if (LNotEqual(Local0, 0x07000000)) {
		err(ts, PK04(z164, __LINE__), 0x008, 0, 0, Local0, 0x07000000)
	}
