...
#if ACPI_EXAMPLE_CODE
/******************************************************************************
 *
 * Example ACPICA initialization code. Two types of initialization are shown:
 *
 * 1) A normal initialization with no early ACPI table access
 *
 * 2) An initialization that requires early access to ACPI tables (before
...
/*
 * This function would be called early in kernel initialization
 */
ACPI_STATUS
 ...
 * dynamic/virtual memory is available.
 */
ACPI_STATUS
InitializeAcpi (void)
{
