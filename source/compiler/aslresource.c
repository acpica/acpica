    ...
    ASL_RESOURCE_DESC           **DescriptorPtr)
{
    ...
    *DescriptorPtr = NEXT_RESOURCE_DESC (Descriptor, ASL_DMA_FORMAT_DESC);
    return;
}
    ...
    ASL_RESOURCE_DESC           **DescriptorPtr)
{
    ...
    *DescriptorPtr = NEXT_RESOURCE_DESC (Descriptor, ASL_END_DEPENDENT_DESC);
    ...
    ASL_RESOURCE_DESC           **DescriptorPtr)
{
    ...
    *DescriptorPtr = NEXT_RESOURCE_DESC (Descriptor, ASL_FIXED_IO_PORT_DESC);
    return;
}
...
/* TBD: The resource list has to appear here in the Descriptor */
    ...
    Descriptor->Exx.Length = 6 /* TBD + number of interrupts */;

    *DescriptorPtr = NEXT_RESOURCE_DESC (Descriptor, ASL_EXTENDED_XRUPT_DESC);
    return;
}
    ...
    ASL_RESOURCE_DESC           **DescriptorPtr)
{
    ...
    *DescriptorPtr = NEXT_RESOURCE_DESC (Descriptor, ASL_IO_PORT_DESC);
    return;
}
    ...
    ASL_RESOURCE_DESC           **DescriptorPtr)
{
    ...
    *DescriptorPtr = NEXT_RESOURCE_DESC (Descriptor, ASL_IRQ_FORMAT_DESC);
    return;
}
    ...
    ASL_RESOURCE_DESC           **DescriptorPtr)
{
    ...
    *DescriptorPtr = NEXT_RESOURCE_DESC (Descriptor, ASL_MEMORY_24_DESC);
    return;
}
    ...
    ASL_RESOURCE_DESC           **DescriptorPtr)
{
    ...
    *DescriptorPtr = NEXT_RESOURCE_DESC (Descriptor, ASL_MEMORY_32_DESC);
    return;
}
    ...
    ASL_RESOURCE_DESC           **DescriptorPtr)
{
    ...
    *DescriptorPtr = NEXT_RESOURCE_DESC (Descriptor, ASL_FIXED_MEMORY_32_DESC);
    return;
}
    ...
    ASL_RESOURCE_DESC           **DescriptorPtr)
{
    ...
    *DescriptorPtr = NEXT_RESOURCE_DESC (Descriptor, UINT8);
    return;
}
