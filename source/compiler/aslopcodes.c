    ...
    ASL_PARSE_NODE              *Node)
{
    ...
    if (!BufferLength)
    {
        ...
        AslWarning (ASL_WARNING_BUFFER_LENGTH, BufferLengthNode->LineNumber);
    ...
    ASL_PARSE_NODE              *Node)
{
    ...
    if (!PackageLength)
    {
        ...
        AslWarning (ASL_WARNING_PACKAGE_LENGTH, PackageLengthNode->LineNumber);
