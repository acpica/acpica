    ...
    ACPI_OPERAND_OBJECT     *EntryDesc)
{
    ...
    if (!EntryDesc)
    {
        ...
        DEBUG_PRINT (ACPI_INFO,
            ("ExDumpOperand: *** Possible error: Null stack entry ptr\n"));
        return (AE_OK);
    }
    ...
    {
        DEBUG_PRINT (ACPI_INFO,
            ("ExDumpOperand: %p is a Pcode pointer\n",
            EntryDesc));
        return (AE_OK);
    }
    ...
    {
        DEBUG_PRINT (ACPI_INFO,
            ("ExDumpOperand: %p Not a local object \n", EntryDesc));
    ...
    DEBUG_PRINT (ACPI_INFO, ("ExDumpOperand: %p ", EntryDesc));
