    ...
    ACPI_WALK_STATE         *WalkState)
{
    ...
    if (ACPI_FAILURE (Status))
    {
        ...
        DEBUG_PRINT (ACPI_ERROR,
            ("AcpiExFatal/AML_FATAL_OP: bad operand(s) (Status=%X)\n",
            Status));
    ...
    ACPI_OPERAND_OBJECT     **ReturnDesc)
{
    ...
    if (ACPI_FAILURE (Status))
    {
        ...
        DEBUG_PRINT (ACPI_ERROR,
            ("AcpiExIndex/AML_INDEX_OP: bad operand(s) (Status=%X)\n",
            Status));
    ...
    if (ObjDesc->Common.Type == ACPI_TYPE_PACKAGE)
    {
        ...
        {
            DEBUG_PRINT (ACPI_ERROR,
                ("ExIndex: Index value out of range\n"));
    ...
    ACPI_OPERAND_OBJECT     **ReturnDesc)
{
    ...
    {
        DEBUG_PRINT (ACPI_ERROR,
            ("ExMatch: operation encoding out of range\n"));
    ...
    {
        DEBUG_PRINT (ACPI_ERROR,
            ("ExMatch: start position value out of range\n"));
        Status = AE_AML_PACKAGE_LIMIT;
        goto Cleanup;
    }
