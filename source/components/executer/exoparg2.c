    ...
    UINT16                  Opcode)
{
    ...
    AmlDumpObjStack (IMODE_Execute, PsGetOpcodeName (Opcode), 2, "after AmlPrepObjStack");
    ...
    UINT16                  Opcode)
{
    ...
    AmlDumpObjStack (IMODE_Execute, PsGetOpcodeName (Opcode), NumOperands, "after AmlPrepObjStack");
