    ...
    ACPI_SIZE               *BufferSpaceUsed)
{
    ...
    *BufferSpaceUsed = 0;
    ...
    case ACPI_TYPE_STRING:
        ...
        *BufferSpaceUsed = ROUND_UP_TO_NATIVE_WORD (InternalObject->String.Length + 1);
    ...
    case ACPI_TYPE_BUFFER:
        ...
        *BufferSpaceUsed = ROUND_UP_TO_NATIVE_WORD (InternalObject->String.Length);
    ...
    case INTERNAL_TYPE_REFERENCE:
        ...
        case AML_INT_NAMEPATH_OP:
            ...
            *BufferSpaceUsed = ROUND_UP_TO_NATIVE_WORD (Buffer.Length);
            break;
    ...
    void                    *Context)
{
    ...
    case ACPI_COPY_TYPE_PACKAGE:
         ...
         */
        ObjectSpace = ROUND_UP_TO_NATIVE_WORD (
