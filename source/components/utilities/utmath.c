    ...
    UINT32                  *OutRemainder)
{
     ...
     */
    ACPI_DIV_64_BY_32 (0, Dividend.Part.Hi, 
                       Divisor.Part.Lo, 
                       Quotient.Part.Hi, Remainder32);
    ACPI_DIV_64_BY_32 (Remainder32, Dividend.Part.Lo, 
                       Divisor.Part.Lo, 
    ...
    ACPI_INTEGER            *OutRemainder)
{
    ...
    if (Divisor.Part.Hi == 0)
    {
        ...
        ACPI_DIV_64_BY_32 (Partial1, Dividend.Part.Lo, 
                           Divisor.Part.Lo, 
    ...
    else
    {
        ...
        Partial2.Full = Quotient.Part.Lo * Divisor.Part.Lo;
