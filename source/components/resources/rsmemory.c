    ...
    ACPI_SIZE               *StructureSize)
{
    ...
    *BytesConsumed = (ACPI_SIZE) Temp16 + 3;
    OutputStruct->Type = ACPI_RSTYPE_MEM24;
    ...
    ACPI_SIZE               *BytesConsumed)
{
    ...
    *Buffer = ACPI_RDESC_TYPE_MEMORY_24;
    ...
    Temp8 = (UINT8) (Resource->Data.Memory24.ReadWriteAttribute & 0x01);
    *Buffer = Temp8;
    Buffer += 1;

    /* Set the Range minimum base address */

    ACPI_MOVE_32_TO_16 (Buffer, &Resource->Data.Memory24.MinBaseAddress);
    Buffer += 2;

    /* Set the Range maximum base address */

    ACPI_MOVE_32_TO_16 (Buffer, &Resource->Data.Memory24.MaxBaseAddress);
    Buffer += 2;
    ...
    ACPI_MOVE_32_TO_16 (Buffer, &Resource->Data.Memory24.RangeLength);
    Buffer += 2;
    ...
    ACPI_SIZE               *StructureSize)
{
    ...
    Buffer += 2;
    *BytesConsumed = (ACPI_SIZE) Temp16 + 3;
    OutputStruct->Type = ACPI_RSTYPE_MEM32;
    ...
    ACPI_SIZE               *StructureSize)
{
    ...
    Buffer += 2;
    *BytesConsumed = (ACPI_SIZE) Temp16 + 3;
    OutputStruct->Type = ACPI_RSTYPE_FIXED_MEM32;
    ...
    ACPI_SIZE               *BytesConsumed)
{
    ...
    *Buffer = ACPI_RDESC_TYPE_MEMORY_32;
    ...
    Temp8 = (UINT8) (Resource->Data.Memory32.ReadWriteAttribute & 0x01);
    *Buffer = Temp8;
    Buffer += 1;

    /* Set the Range minimum base address */

    ACPI_MOVE_32_TO_32 (Buffer, &Resource->Data.Memory32.MinBaseAddress);
    Buffer += 4;

    /* Set the Range maximum base address */

    ACPI_MOVE_32_TO_32 (Buffer, &Resource->Data.Memory32.MaxBaseAddress);
    Buffer += 4;
    ...
    ACPI_MOVE_32_TO_32 (Buffer, &Resource->Data.Memory32.RangeLength);
    Buffer += 4;
    ...
    ACPI_SIZE               *BytesConsumed)
{
    ...
    *Buffer = ACPI_RDESC_TYPE_FIXED_MEMORY_32;
    ...
    Temp8 = (UINT8) (Resource->Data.FixedMemory32.ReadWriteAttribute & 0x01);
    *Buffer = Temp8;
    Buffer += 1;
    ...
    ACPI_MOVE_32_TO_32 (Buffer,
        &Resource->Data.FixedMemory32.RangeBaseAddress);
    Buffer += 4;

    /* Set the range length */

    ACPI_MOVE_32_TO_32 (Buffer,
        &Resource->Data.FixedMemory32.RangeLength);
    Buffer += 4;
