...
#define ACPI_GPE_RAW_HANDLER            (UINT8) 0x10
#define ACPI_GPE_XRUPT_FLAG_MASK        (UINT8) 0x10

#define ACPI_GPE_FORCE_ENABLE           (UINT8) 0x20
#define ACPI_GPE_FORCE_DISABLE          (UINT8) 0x40
#define ACPI_GPE_FORCE_FLAG_MASK        (UINT8) 0x60
