...
#define AE_NOT_EXIST        (ACPI_STATUS) 0x000D
#define AE_EXIST            (ACPI_STATUS) 0x000E
#define AE_TYPE             (ACPI_STATUS) 0x000F
#define AE_NULL_ENTRY       (ACPI_STATUS) 0x0010
#define AE_BUFFER_OVERFLOW  (ACPI_STATUS) 0x0011
#define AE_STACK_OVERFLOW   (ACPI_STATUS) 0x0012
#define AE_STACK_UNDERFLOW  (ACPI_STATUS) 0x0013
#define AE_NOT_IMPLEMENTED  (ACPI_STATUS) 0x0014
#define AE_VERSION_MISMATCH (ACPI_STATUS) 0x0015
#define AE_BAD_SIGNATURE    (ACPI_STATUS) 0x0016
#define AE_SUPPORT          (ACPI_STATUS) 0x0017
#define AE_SHARE            (ACPI_STATUS) 0x0018
#define AE_LIMIT            (ACPI_STATUS) 0x0019
#define AE_UNKNOWN_STATUS   (ACPI_STATUS) 0x001A
#define ACPI_MAX_STATUS     (ACPI_STATUS) 0x001A
