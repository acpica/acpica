...
/*
 * Maximum number of While() loop iterations and timeout before forced
 * method abort. This mechanism is intended to prevent infinite loops
 * during interpreter execution within a host kernel.
 */
ACPI_INIT_GLOBAL (UINT32,           AcpiGbl_MaxLoopIterations, ACPI_MAX_LOOP_COUNT);
ACPI_INIT_GLOBAL (UINT64,           AcpiGbl_MaxLoopTimeout, ACPI_MAX_LOOP_TIMEOUT);
