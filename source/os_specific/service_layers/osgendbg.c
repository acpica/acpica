...
/******************************************************************************
 *
 * FUNCTION:    AcpiOsInitializeCommandSignals
 *
 * PARAMETERS:  None
 *
 * RETURN:      Status
 *
 * DESCRIPTION: Initialize signals used by the multi-threading debugger
 *
 *****************************************************************************/

ACPI_STATUS
AcpiOsInitializeCommandSignals (
    void)
{
    ACPI_STATUS             Status;
...
/******************************************************************************
 *
 * FUNCTION:    AcpiOsTerminateCommandSignals
 *
 * PARAMETERS:  None
 *
 * RETURN:      None
